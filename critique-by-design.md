| [home page](README.md) | [visualizing-government-debt](https://data-viewer.oecd.org/?chartId=2d210203-d431-40b6-bac9-ee0f94384f6b) | [critique by design](critique-by-design.md) | [final project I](final-project-part-one.md) | [final project II](final-project-part-two.md) | [final project III](final-project-part-three.md) |
...
With my interviews finished, I set out into Tableau to try and build a visualization that met what the interviewees told me. What mostly stuck out to me was designing the graphic with the men and women side by side. This was my result:

![First Attempt in Tableau](FirstTableau.png)

_I don't like it_. I think the colors and bars mash together really poorly, and this results in a feeling of confusion and being hit by so many colors at once. I wasn't able to figure out how to adjust the row width. I was hoping that it would look better if I could bring men and women together on the same animal and then a larger width between the animals. I tried but couldn't figure out. The graph above is what I presented to my data visualization critique group, and they shared my sentiments. The graphic looked garish and was more confusing than the original. It was at this point that I showed the sketch to the critique group, and they both agreed that the sketch was easier to read. With that valuable knowledge taken to heart, I decided that I should try to create a visualization to be more similar to my sketch. 

To do this, I decided to revert back to the butterfly chart. This was the single largest change between the drafts. I did not know how to create a butterfly chart in Tableau, so I found a tutorial online to teach me. Here is the [YouTube Video](https://www.youtube.com/watch?v=cKeTKqX25IM) I watched to teach me how to make the chart (Video posted by DataScience RoadMap, March 5, 2023).

From this video, I also got the idea of adding a gradient to the colors of the bars. While the colors I had used before were not as jarring with the red and blue lines being on different sides of the chart, it still felt kind of flat. Near the end of the video, DataScience RoadMap adds a gradient to his visualization, and I preferred how that looked. I decided to make the larger percentages darker colors and then get lighter as we descend because I see dark colors as being "more," so the darker numbers mean more people think they can beat that animal in a fight. Not only did I find it this change more visually interesting, but I also noticed that it highlighted how different some of the data was. For example, men have a much darker color for "Medium Size Dog" and "Goose" when compared to women. It's a small detail, but you can notice that the colors are not exact shades between men and women, which gives the reader some information even if they don't directly process it.

I decided to keep the title with the bolded "Animals Could You Beat" and "Unarmed Fight." I wanted to draw special emphasis to the **unarmed** aspect as it was not only something I noticed, but my second interviewer thought that my sketch didn't bring enough attention to it. I also added the demographics and number of people surveyed to the methodologies caption at the bottom of the graphic as this was a specific request from an interviewee. 

I took a lot of time to edit the ToolTip Box of the graphic. Whenever you highlight an animal, it will show the animal name and the percentage of men and women in their own colors. I also added this to the individual bars. If you highlight the men's bar for rat, you will get the response: "76% of Men believe that they could beat a rat in an unarmed fight." I wanted to add this to make the data very clear if someone were to highlight a bar. Once again, I also wanted to highlight the _unarmed_ aspect of this fight as I think it's a crucial detail.

I think the Axes were a little wonky in my first attempt. My original x-axis title was "Percentage of Men/Women that believe they could beat that animal." _Weird right?_ It didn't flow at all, at least in my opinion. If I were to read this as someone new to this graphic, the axis would leave me more puzzled than reassured. So I scrapped the axis title and gave each side "% of Men" or "% of Women." Much cleaner and a lot easier to understand in my opinion. I also bolded and increased the size of the animal names to make them much more prominent. When they were unbolded and kind of small to the left of the graphic, they were kind of out-of-sight, out-of-mind. But the animals are the whole point of the graphic. That's why I decided to center their names, increase their font size, and bold them. Now the animals are up front and center, you can't miss 'em. 

I hope you enjoyed reading about this process as I had going through it! Now, for the moment we've all been waiting for, here is my finalized graphic:

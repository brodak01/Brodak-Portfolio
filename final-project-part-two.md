...
|-------------------------|--------------------------------|-------------|-------------|
| Overall, were you able to understand what each graphic was saying, or were the graphics confusing? | The first graphic was difficult to understand, the rest were much easier to understand.            |     I was not sure what the colors meant in the US visual - which states had AZA zoos? Assume dark green, but unsure.        |       Was unclear if darker colors meant more zoos. Does no color mean no zoos? The rest of the diagrams made sense.      |
| What would you change about the graphics to make them better to understand or look better?                        |             The first graphic could be designed as overlapping so that the two different enclosure sizes are easier to understand. The font size should be increased and the font color should be darkened. A scale should be added to the map.                   |      A legend for the first graphic.       |        Elephants should be a pie chart, a few animal pictures on the graphics could be nice.     |
|   What do you think of the message that these graphics are trying to tell?                    |             The interviewee understood the message from each of the graphics.                   |      How much funding various states have to dedicate to zoos - and whether or not their verification goes hand in hand with funding.       |        We are investing more in animal conservation and this is optimistic for animal welfare.     |
|   Is there a specific audience that would be interested in these graphics?                     |             Conservationists                   |      Animals lovers and anyone interested in zoo business.       |        Students and policy makers, but the general public would be interested in this as well.     |
|    Are there any aspects that you are curious about that were not addressed in this draft?                     |             They were interested in how captive animal lifespans changed throughout time. Has the research done at zoos resulted in captive animals living longer over time?                   |      What does AZA certified mean? Does more funding mean better care for the animals?       |        What animals and habitats are receiving the funding. For example, mammals vs. insects, rainforests vs. aquariums.     |
...
|     Overlap the habitat maps        |                                If the two habitat squares were overlapping, I think the data would be much easier to understand. I think overlapping makes more sense than the pie chart, though I might look into it to see if I think it works. If I can figure out how to do this, the visualization will be a lot easier to understand!                                                 |
|      Which animals are being prioritized       |                         I think this will be an easy addition! I actually found some data on where reseach is being directed for each animal group (birds are the most), so this should not be difficult to add!                                                        |
|       Adding Animal graphics.      |                 I was planning on adding pictures to my shorthand presentation, but I can see if adding animal graphics would benefit the diagrams as well. At this point I don't think so, but it's worth investigating.                                                                |
